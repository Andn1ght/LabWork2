public class MyLinkedList<E> implements MyList<E> {
    ...
    private void addFirst(E element) {
        Node<E> newNode = new Node<>(element, null, tail); //create a new node to hold the element
        if (tail != null) {
            tail.next = newNode; //set the next pointer of the previous head to the new node
        } else {
